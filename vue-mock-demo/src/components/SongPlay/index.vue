...
<template>
  <div class="con">
    ...
    >
      ...
      <div
        v-if="lrcShow"
        :class="{rotating:audio.playing}"
        class="logo"
        @click="lrcShow = !lrcShow"
      >
        <img
          :src="logoUrl"
          class="bg"
      ...
      >
        ...
        <ul v-if="lrcList.length >=0">
          <li
            v-for="(v,index) in lrcList"
            :key="index"
            :class="{currLrc:index===lrcIndex}"
          >
            {{ v }}
          </li>
        </ul>
              ...
              >
                <span @click="startPlayOrPause">
                  <svg-icon
                    ...
                    :icon-class="audio.playing?'play':'pause'"
                  />
                </span>
              </el-col>
              <el-col :span="2">
                ...
                >
                  <svg-icon
                    :icon-class="'volume'"
                    @click.stop="volumeShow = !volumeShow"
                  />
                  <div
                    v-if="volumeShow"
                    class="volSlideCon"
