    ...
    <el-main>
      <div class="wrap">
        ...
        >
          <i
            data-command="undo"
            class="command el-icon el-icon-arrow-left"
            title="撤回"
          />
          <i
            data-command="redo"
            class="command el-icon el-icon-arrow-right"
            title="重做"
          />
          <i
            data-command="delete"
            class="command el-icon el-icon-delete"
            title="删除"
          />
          <i
            data-command="zoomOut"
            class="command el-icon el-icon-zoom-out"
            title="缩小"
          />
          <i
            data-command="zoomIn"
            class="command el-icon el-icon-zoom-in"
            title="放大"
          />
          <i
            data-command="copy"
            class="command el-icon el-icon-document-copy"
            title="复制"
          />
          <i
            data-command="paste"
            class="command el-icon el-icon-document-add"
            title="粘贴"
          />
          <i
            data-command="save"
            class="command el-icon el-icon-upload"
            title="保存"
          />
        </div>
        <el-row :gutter="20">
