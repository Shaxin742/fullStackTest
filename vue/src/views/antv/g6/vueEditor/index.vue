...
export default {
  ...
  mounted() {
    ...
    let data = {"nodes":[{"clazz":"userTask","size":[80,44],"label":"审批节点","shape":"user-task-node","x":153.90625,"y":96,"id":"userTask1574685449875"},{"clazz":"scriptTask","size":[80,44],"label":"脚本节点","shape":"script-task-node","x":265.90625,"y":170,"id":"scriptTask1574685450956"}],"edges":[{"clazz":"flow","source":"userTask1574685449875","target":"scriptTask1574685450956","sourceAnchor":1,"targetAnchor":0,"shape":"flow-polyline-round","startPoint":{"x":194.40625,"y":96,"index":1},"endPoint":{"x":265.90625,"y":147.5,"index":0}}],"groups":[]}
    this.data = data
